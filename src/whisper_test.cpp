...
int main(int argc, char **argv) {
    const char *modelPath = "/usr/share/ru.alx114.SpeechNotes/models/ggml-tiny-q8_0.bin";
    const char *wavPath = "/usr/share/ru.alx114.SpeechNotes/test-audio/test_16k.wav";
