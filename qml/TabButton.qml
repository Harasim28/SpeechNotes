...
Item {
    ...
    Canvas {
        ...
        onPaint: {
            ...
            ctx.reset()
            ctx.strokeStyle = isActive ? Theme.highlightColor : Theme.secondaryColor
            ctx.fillStyle = isActive ? Theme.highlightColor : Theme.secondaryColor
            ctx.lineWidth = 2.5
            ctx.lineCap = "round"
            ctx.lineJoin = "round"
            var cx = width / 2
    ...
    Label {
        ...
        color: isActive ? Theme.highlightColor : Theme.secondaryColor
