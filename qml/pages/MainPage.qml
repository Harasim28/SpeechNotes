    ...
    SilicaFlickable {
        ...
        Column {
            ...
            Rectangle {
                ...
                height: 100
                radius: 16
                color: audioRecorder.isRecording ? Theme.rgba(Theme.highlightColor, 0.12) : Theme.rgba(Theme.secondaryColor, 0.06)
                x: Theme.horizontalPageMargin
                border.width: 1
                border.color: audioRecorder.isRecording ? Theme.rgba(Theme.highlightColor, 0.3) : Theme.rgba(Theme.secondaryColor, 0.15)
                ...
                Row {
                    ...
                    Repeater {
                        ...
                        Rectangle {
                            ...
                            height: 10
                            radius: 3
                            color: audioRecorder.isRecording ? Theme.highlightColor : Theme.secondaryColor
                            Behavior on height {
            ...
            Item {
                ...
                Rectangle {
                    ...
                    height: 100
                    radius: 50
                    color: audioRecorder.isRecording ? Theme.rgba(Theme.highlightColor, 0.25) : Theme.rgba(Theme.highlightColor, 0.1)
                ...
                Rectangle {
                    ...
                    color: audioRecorder.isRecording ? "red" : Theme.highlightColor
                    Behavior on radius {
            ...
            Row {
                ...
                Rectangle {
                    ...
                    height: 70
                    radius: 35
                    color: audioRecorder.isPaused ? "orange" : Theme.rgba(Theme.secondaryColor, 0.15)
